...
# 注册
curl -X POST -H 'Content-type:application/json' $baseURL/logon -d '{"user_name":"yb3616","password":"123123","email":"yb3616@sina.com","phone":"17376587892"}'
curl -X POST -H 'Content-type:application/json' $baseURL/logon -d '{"user_name":"ybin","password":"123123","email":"yb3616@qq.com","phone":"13754227856"}'
